  <?php
	...
	$sql = "update volunteertbl set pnumber = '".$pnumber."',sdate = '".$sdate."', vwhere = '".$vwhere."' where vname = '".$vname."'";
	...
	echo "<center><h1>정보 수정 결과</h1></center><br>";
	...
	echo "<center><br><br><br><a href=volunteer_list.php>[봉사자 목록]</a><br><br><a href=hpme.html>[메뉴 화면]</a></center>";
